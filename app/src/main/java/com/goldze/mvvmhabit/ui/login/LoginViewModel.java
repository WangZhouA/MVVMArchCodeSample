...
public class LoginViewModel extends BaseViewModel<DemoRepository> {
    ...
    public StockLiveData stockLiveData = new StockLiveData();

    public class StockLiveData extends LiveData<String> {

        @Override
        protected void onActive() {
            Log.i("StockLiveData", "onActive: ");
        }

        @Override
        protected void onInactive() {
            Log.i("StockLiveData", "onInactive: ");
        }
    }
        ...
        addSubscribe(mModel.login()
                ...
                .subscribe(new Consumer<Object>() {
                    ...
                    public void accept(Object o) throws Exception {
                        dismissDialog();
                        //保存账号密码
                        mModel.saveUserName(userName.get());
                        mModel.savePassword(password.get());
                        //进入DemoActivity页面
    ...
    public void onDestroy(@NonNull LifecycleOwner owner) {
        Log.i("LoginViewModel", "commonLog - onDestroy: ");
    }
}
