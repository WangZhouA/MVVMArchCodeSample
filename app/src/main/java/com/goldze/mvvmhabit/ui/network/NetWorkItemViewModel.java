...
public class NetWorkItemViewModel extends ItemViewModel<NetWorkViewModel> {
    ...
    public int getPosition() {
        return mViewModel.getItemPosition(this);
    }
    ...
    public BindingCommand itemClick = new BindingCommand(new BindingAction() {
        ...
        public void call() {
            ...
            if (entity.get().getId() == -1) {
                mViewModel.deleteItemLiveData.setValue(NetWorkItemViewModel.this);
            } else {
                //跳转到详情界面,传入条目的实体对象
                Bundle mBundle = new Bundle();
                mBundle.putParcelable("entity", entity.get());
                mViewModel.startContainerActivity(DetailFragment.class.getCanonicalName(), mBundle);
            }
        }
    });
    //条目的长按事件
